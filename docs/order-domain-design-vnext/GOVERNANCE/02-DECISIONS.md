...
| TD-002 | TARGET_DECISION | Preserve actual project names. Domain depends only on generic Framework.Core/BCL, never integration Messages. Application owns use cases and outbound port contracts. |
