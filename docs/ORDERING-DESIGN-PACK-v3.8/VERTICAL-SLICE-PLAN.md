...
| [B0](SLICES/B0.md) | The existing solution starts as an authenticated empty-business service with verified SQL Server persistence/migrations and durable messaging semantics in the team-approved test environment. | `ARCHITECTURE/02-BOOTSTRAP.md` |
