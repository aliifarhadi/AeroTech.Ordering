    ...
    public sealed class AnonymousSurfaceInventoryTests
    {
        ...
        public void Current_controller_surface_is_exactly_the_characterized_inventory()
        {
            ...
            var expected = new[]
            {
                ...
                "RestApi.V1.OrderAggregate.Controllers.BackofficeController GET Backoffice/v{version:apiVersion}/Orders/{id:long} authorize=True",
                "RestApi.V1.OrderAggregate.Controllers.BackofficeController POST Backoffice/v{version:apiVersion}/Orders/FlightOffers authorize=True",
                "RestApi.V1.OrderAggregate.Controllers.InternalController POST Internal/v{version:apiVersion}/Orders/{id:long}/ProjectionRebuilds authorize=False",
                "RestApi.V1.OrderAggregate.Controllers.OtaController GET Api/v{version:apiVersion}/Bookings/{id:long} authorize=True",
                "RestApi.V1.OrderAggregate.Controllers.OtaController POST Api/v{version:apiVersion}/Bookings/FlightOffers authorize=True",
                "RestApi.V1.OrderAggregate.Controllers.OtaPanelController GET OtaPanel/v{version:apiVersion}/Bookings/{id:long} authorize=True",
                "RestApi.V1.OrderAggregate.Controllers.OtaPanelController POST OtaPanel/v{version:apiVersion}/Bookings/FlightOffers authorize=True",
                "RestApi.V1.OrderAggregate.Controllers.ServiceController GET Service/v{version:apiVersion}/Bookings/{id:long} authorize=False",
                "RestApi.V1.OrderAggregate.Controllers.ServiceController POST Service/v{version:apiVersion}/Bookings/FlightOffers authorize=False",
